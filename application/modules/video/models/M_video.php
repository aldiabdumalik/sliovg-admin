...
class M_video extends CI_Model {
	...
	var $table = 't_video'; //nama tabel dari database
    var $column_order = array(null,'id_video','nama_kategori','video','thumb','nama_video','deskripsi_video'); //field yang ada di table user
    var $column_search = array('id_video','nama_kategori','video','thumb','nama_video','deskripsi_video'); //field yang diizin untuk pencarian 
    ...
    public function getVideoWhere($id)
    {
        $this->db->join('t_kategori', 't_kategori.id_kategori = t_video.id_kategori', 'left');
        $this->db->from($this->table);  
    ...
    public function countAllKategori()
    {
        ...
        return $this->db->get('t_video')->num_rows();
    }
    ...
    public function countPerKategori()
    {
        ...
        return $this->db->get('t_video')->result_array();
    }
}
